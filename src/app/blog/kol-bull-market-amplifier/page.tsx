    ...
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="prose-custom space-y-4 text-text-muted leading-relaxed [&_strong]:text-text">
        ...
        <FadeIn>
          ...
          <p>
            還有一個比較結構性的觀察是會員內容。公開影片講的多半是通用而穩健的原則：別開槓桿、留現金流、定投。會員內容要撐起付費的稀缺感，反而更容易走向具體點位、機構意圖、高確信的預測。這不見得是刻意的：市場不會每天長出真正稀缺的洞見，但會員每天都要收到「只有這裡聽得到」的東西，推測就會被講得越來越具體。我現在的用法剛好反過來：公開的通用原則參考權重高一點，越像私藏預測的內容，權重越低。
          </p>
          <p>
        ...
        <FadeIn>
          ...
          <p>
            這跟德州撲克的邏輯一樣：贏一手不代表打法對，輸一手不代表決策錯。D 大是前職業德撲選手，這套思路他講起來特別有說服力；自己也打過一段時間德撲，最高大概穩定打到 NL25，深感投資市場跟德撲有很多相似之處。但兩者差在德撲一手會結束，逼你看著結果想下一手，投資沒有這個明確的結算點，於是不認錯的特質很容易把錯誤展延很久。
          </p>
          <p>
        ...
        <FadeIn>
          ...
          <p>
            但這種槓桿跟金融槓桿有一個關鍵差別：<strong>沒有強制平倉。</strong>看錯的時候，時間尺度可以拉長、預測可以改寫成長期 thesis、可以歸因給黑天鵝或有人操控，或者用新內容蓋過去，只留下看對的那些。金融槓桿看錯會被清算；聲譽槓桿看錯，多半只是折損一部分信用。
          </p>
          <p>
          ...
          <p>
            另一頭，也有一批很少表態的創作者，主要整理新聞、翻譯公告，不太給方向。這種風格常被當成比較中立，但其實是另一種安全牌：犯大錯的機率低、不容易被追究，同時提供的決策價值跟可驗證性也低。而且選擇報哪些新聞、標題怎麼下，本身還是有立場，「我只是分享」有時候只是把立場藏得比較深。
          </p>
          <p>
            一種人把自己的判斷槓桿化，一種人靠不表態降低被檢驗的風險。方向感跟篩選效率都有用，也都有各自的盲點。我現在看內容比較在意的只剩一件事：他能不能讓我分得出來，哪些是事實、哪些是他的推論、哪些是行動建議，以及哪些地方連他自己也不確定。
          </p>
        </FadeIn>
