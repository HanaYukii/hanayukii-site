    ...
    <article className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="prose-custom space-y-4 text-text-muted leading-relaxed [&_strong]:text-text">
        ...
        <FadeIn>
          ...
          <div className="space-y-4">
            <p>
              長期累積的東西到這時候已經爆發了，夏天在日本 WFA 了一陣子想調整，但整個人狀態很差。
        ...
        <FadeIn>
          ...
          <p>
            ...
            一大原因是覺得自己的心態還在需要調適的階段，而且條件確實不俗，跟熟人合作也更有彈性。
        ...
        <FadeIn>
          ...
          <div className="space-y-4">
            <p>
              ...
              像 Jane Street 這種等級的公司，我甚至是去年才第一次聽到，多數人也未必了解它的含金量。
              但我完全可以定位自己在這樣的位置，未來如果還想挑戰海外大廠或量化，也會做好更充分的準備。
