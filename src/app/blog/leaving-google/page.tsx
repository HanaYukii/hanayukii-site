      ...
      <div className="prose-custom space-y-4 text-text-muted leading-relaxed [&_strong]:text-text">
        ...
        <FadeIn>
          ...
          <div className="space-y-4">
            ...
            <p>
              什麼叫做強？我自認專長在 problem solving、邏輯跟程式設計，有超出大多數人的實力，在裡面的日子甚至沒有遇到我真心認為這方面比我強的——大家做事能力很好，但這跟我的強項是不同維度。
              多年的競賽訓練讓我在 problem solving 上有很不一樣的直覺跟深度，也對於如何做出架構好、邏輯正確的程式很有概念，這跟面試前短期刷題練出來的是不同層次的東西。而在一個 domain 經驗為主、偏維運的環境裡，這些完全佔不到優勢。
